...
* La fecha de entrega límite para promocionar la asignatura es 22/06/2026. Para el caso del examen final, este TP se debe enviar al menos una semana antes de presentarse a rendir a los efectos de contar con tiempo para la corrección y, eventualmente, realizar cambios.

#### Actividades

#### Preparatoria

* Antes de la realización de este trabajo usted debe preparar sus propios datos para la prueba. Para ello, descargue la plantilla HTML\footnote{\url{https://github.com/redesunlu/tyr-trabajos-practicos/blob/main/images/TP-Final-template.html?raw=True}} y complétela con sus datos. Renombre el archivo \texttt{index.html} (todo en minúsculas).
...
3. Copie la plantilla con sus datos al directorio público del servidor \texttt{datos.tpfinal-tyr.com}.
